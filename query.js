...
async function querychaincode(USER_NAME, CHANNEL_NAME, CHAIN_CODE_NAME, CHAIN_CODE_FUNCTION_NAME, ...ARGS) {
    ...
    try {
        ...
        if (!userExists) {
            ...
            console.log(`Transaction has been evaluated, result is: ${return_value.toString()}`);
